				...
				<div class="pages">
					<table width="90%" border="0" cellspacing="1" cellpadding="1">
							<tr>
								...
								<td align="center" width="15%"><font size="4">邮件标题</font></td>
								<td align="center" width="30%"><font size="4">内容</font></td>
								<td align="center" width="13%"><font size="4">是否已读</font></td>
								<td align="center" width="28%"><font size="4">时间</font></td>
								<td align="center" width="8%"><font size="4">删除</font></td>
							</tr>		
							 ...
							 <tr>
								<form id="mailForm" name="mailForm" action="###" method="post">
								 <table width="90%" border="0" cellspacing="0" cellpadding="0">
									...
									<td align="center" width="30%"><font size="4">${mail.context}</font></td>
									<td align="center" width="13%"><font size="4">${mail.isread==1?"已读":"未读"}</font></td>
									<td align="center" width="28%"><font size="4">${mail.time}</font></td>
									<td align="center">
										<input type="hidden" name="id" value="${mail.id}" />
									</td>
									<td align="center" width="8%">																														
										<a href="javascript:void(0)" onclick="removeMail(${vs.count})"><font size="4">删除</font></a>										
									</td>
									</tr>
									</table>
								</form>	
							...
							<br/>
								<div style="text-algin: center">			
									<ul id="pageUl" >
										...
										<c:if test="${mailPageBean.currentPage!=1}">
											<li><a href="${pageContext.request.contextPath}/mail/toread?currentPage=${mailPageBean.currentPage-1}">上一页</a></li>
										</c:if>
										<c:forEach begin="1" end="${mailPageBean.totalPage}" var="page">
											...
											<c:if test="${page!=mailPageBean.currentPage}">
												<li><a href="${pageContext.request.contextPath}/mail/toread?currentPage=${page}">${page}</a></li>
											</c:if>
											</c:forEach>
											...
											<c:if test="${mailPageBean.currentPage!=mailPageBean.totalPage}">
												<li><a href="${pageContext.request.contextPath}/mail/toread?currentPage=${mailPageBean.currentPage+1}">下一页</a></li>
											</c:if>
										</ul>
									</div>			
								</td>
