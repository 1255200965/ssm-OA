...
<body>
	...
	<div class="status">
		<div class="global-width">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
				href="${pageContext.request.contextPath}/user/exit">注销</a>
		</div>
	</div>
<form id="whiteMail" name="whiteMail"  action="${pageContext.request.contextPath}/mail/white" enctype="multipart/form-data" method="post">     
						...
						<table width="90%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td align="left"><input type="text" name="subject"
									id="m_si" />&nbsp;<font color="red">*</font></td>
							</tr>
							<tr>
								<td align="right" width="30px" height="40px">邮件内容：</td>
								<td align="left"><textarea name="context" rows="10px"
										cols="40px"></textarea></td>
							</tr>
							<tr>
