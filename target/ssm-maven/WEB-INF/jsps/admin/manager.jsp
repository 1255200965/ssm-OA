				...
				<div class="pages">
					<table width="90%" border="0" cellspacing="1" cellpadding="1">
							<tr>
								...
								<td align="center" width="15%"><font size="4">用户名</font></td>
								<td align="center" width="20%"><font size="4">昵称</font></td>
								<td align="center" width="25%"><font size="4">手机</font></td>
								<td align="center" width="20%"><font size="4">地址</font></td>
								<td align="center" width="10%"><font size="4">删除</font></td>
							</tr>	
							<c:forEach items="${UserpageBean.pageData}" var="user" varStatus="vs">								
							 <tr>
								<form id="managerForm" name="managerForm" action="###" method="post">
								 <table width="90%" border="0" cellspacing="0" cellpadding="0">
									...
									<td align="center" width="15%">		
										<font size="4">${user.username}</font>
									</td>
									<td align="center" width="20%"><font size="4">${user.name}</font></td>
									<td align="center" width="25%"><font size="4">${user.phone}</font></td>
									<td align="center" width="20%"><font size="4">${user.address}</font></td>
									<td align="center">
										<input type="hidden"  name="id" value="${user.id}" />
									</td>
									<td align="center" width="10%">				
										<a href="javascript:void(0)" onclick="deleteUser(${vs.count})"><font size="4">删除</font></a>
									</td>
									</tr>							
								</table>
								</form>	
							...
							<c:if test="${UserpageBean.totalCount!=0}">
							<tr>							
							<td >
							<br/>
								<div style="text-algin: center">			
									<ul id="pageUl" >
										...
										<c:if test="${UserpageBean.currentPage!=1}">
											<li><a href="${pageContext.request.contextPath}/user/admin/tomanager?currentPage=${UserpageBean.currentPage-1}">上一页</a></li>
										</c:if>
										<c:forEach begin="1" end="${UserpageBean.totalPage}" var="page">
											...
											<c:if test="${page!=UserpageBean.currentPage}">
												<li><a href="${pageContext.request.contextPath}/user/admin/tomanager?currentPage=${page}">${page}</a></li>
											</c:if>
											</c:forEach>
											...
											<c:if test="${UserpageBean.currentPage!=UserpageBean.totalPage}">
												<li><a href="${pageContext.request.contextPath}/user/admin/tomanager?currentPage=${UserpageBean.currentPage+1}">下一页</a></li>
											</c:if>
										</ul>
									</div>			
								</td>
