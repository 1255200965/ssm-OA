...
<script>
			...
			$(function(){
				$("#n_endtime").blur(
					function(){
						$.get(
							"${pageContext.request.contextPath}/note/process",
							{"endtime":this.value,"begintime":$("#n_begintime").val()},
							function(data){
								if(data!=null){										
									$("#n_day").val(data);
													}	
			...
			$(function(){
				$("#n_begintime").blur(
					function(){
						$.get(
							"${pageContext.request.contextPath}/note/process",
							{"begintime":this.value,"endtime":$("#n_endtime").val()},
							function(data){
								if(data!=null){										
									$("#n_day").val(data);
													}	
					...
					<div class="action">
						...
						<div class="pages">
							...
							<tr>
								...
								<td align="left">
									<input type="date"  name="begintime"  id="n_begintime" />&nbsp;<font color="red">*</font>
								</td>
							</tr>
							<tr>
								<td align="right" width="30%" height="30px">结束时间：</td>
								<td align="left">
									<input type="date" name="endtime"  id="n_endtime" />&nbsp;<font color="red">*</font>
								</td>
							</tr>
							<tr>
								<td align="right" width="30%" height="30px">请假天数：</td>
								<td align="left">
									<input type="text" name="day"  id="n_day" />&nbsp;<font color="red">*</font><font color="red">您的加班时间为：${countwork.counttime}小时</font>
								</td>
							</tr>
							<tr>
