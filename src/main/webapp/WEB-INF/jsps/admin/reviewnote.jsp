...
<html>
	<head>
		...
		<script>
			function reviewYes()
			{				
				document.forms[0].action="${pageContext.request.contextPath}/note/admin/reviewYes";
				document.forms[0].submit();
			}
			function reviewNo()
			{
				document.forms[0].action="${pageContext.request.contextPath}/note/admin/reviewNo";
				document.forms[0].submit();
			}
			function back(){
				var con = confirm("确定要离开我么？");
				if (con) {
					location.href="${pageContext.request.contextPath }/note/admin/toreviewlist";		
					}
				}			
		</script>
	</head>
	...
	<body>
		...
		<form id="reviewForm" name="reviewForm" action="##" method="post">
			<input type="hidden" name="id" value="${reviewnote.id}" /> 
			<div class="main">
			<div class="global-width">	 
					...
					<div class="action">
						...
						<div class="pages">
							...
							<tr>
								...
								<td align="left">
									<input type="text" name="apply.name" value="${reviewnote.apply.name}" readonly="readonly" id="n_name" />
								</td>							
							</tr>
							<tr>
								<td align="right" width="30%" height="30px">开始时间：</td>
								<td align="left">
									<input type="text" name="begintime"  id="begintime" value="${reviewnote.begintime}" readonly="readonly"/>
								</td>
							</tr>
							<tr>
								<td align="right" width="30%" height="30px">结束时间：</td>
								<td align="left">
									<input type="text" name="endtime"  id="endtime" value="${reviewnote.endtime}" readonly="readonly"/>
								</td>
							</tr>
							<tr>
								<td align="right" width="30%" height="30px">请假天数：</td>
								<td align="left">
									<input type="text" name="day"  id="si" value="${reviewnote.day}" readonly="readonly"/>
								</td>
							</tr>
							<tr height="60px">
								<td align="right" width="30px" height="40px">请假原因：</td>
								<td align="left">					
									<textarea name="cause" rows="10px" cols="40px" readonly="readonly">${reviewnote.cause}</textarea>
								</td>								
							</tr>
							<tr>							
