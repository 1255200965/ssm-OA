				...
				<div class="pages">
					<table width="90%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td align="center" width="15%"><font size="3">申请人</font></td>
								<td align="center" width="20%"><font size="3">开始时间</font></td>
								<td align="center" width="20%"><font size="3">结束时间</font></td>
								<td align="center" width="5%"><font size="3">天数</font></td>
								<td align="center" width="15%"><font size="3">审批状态</font></td>
								<td align="center" width="15%"><font size="3">原因</font></td>
								...
								<form id="myForm" name="myForm" action="###" method="post">
								 <table width="90%" border="0" cellspacing="0" cellpadding="0">
									...
									<td align="center" width="15%">		
										<font size="3">${note.apply.name}</font>		
									</td>
									<td align="center" width="20%"><font size="3">${note.begintime}</font></td>
									<td align="center" width="20%"><font size="3">${note.endtime}</font></td>
									<td align="center" width="5%"><font size="3">${note.day}</font></td>
									<td align="center" width="15%">
										<c:if test="${note.isreview==1}"><font size="3">已审核</font></c:if>
										<c:if test="${note.isreview==2}"><font size="3">未审核</font></c:if>
										<c:if test="${note.isreview==3}"><font size="3">审核不通过</font></c:if>								
									</td>
									<td align="center" width="15%"><font size="3">${note.cause}</font></td>
									<td align="center" >
										<input type="hidden" name="id" value="${note.id}" />
									</td>
									<td align="center" width="5%">																														
										<a href="javascript:void(0)" onclick="deleteNote(${vs.count})"><font size="3">删除</font></a>
									</td>
									</tr>
									</table>
								</form>	
